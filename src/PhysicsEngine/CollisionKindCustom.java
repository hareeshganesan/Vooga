...
public class CollisionKindCustom extends CollisionKind
{
     ...
     * 
     * @param classOne the certain class type one
     * @param typeOne the sprite is what type to classOne
     * @param relation the requriment
     * @param classTwo the certain class type two
     * @param typeTwo the sprite is what type to classTwo
     */
    public void setType (Class<?> classOne,
                         CollisionKindCustom.Type typeOne,
                         CollisionKindCustom.Relation relation,
                         Class<?> classTwo,
