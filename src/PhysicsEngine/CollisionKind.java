...
public abstract class CollisionKind
{
     ...
     * @param spriteOne sprite one
     * @param spriteTwo sprite two
     * @param physicsEngine the physics engine we need to set new location
     *            increment
     */
     ...
     * 
     * @param reaction the reaction that needs to be removed
     */
     ...
     * 
     * @param reaction the reaction needs to be set
     */
     ...
     * 
     * @param reactions the reaction list that need to be set
     */
