...
//		BufferedImage imgLLL = GraphicsTest.loadImage("src/resources/bodyParts/limb.png"); //nlimb
        ...
        BufferedImage imgH =
            GraphicsTest.loadImage("src/resources/bodyParts/head.png");
        BufferedImage imgT =
            GraphicsTest.loadImage("src/resources/bodyParts/torso.png");
        BufferedImage imgLA =
            GraphicsTest.loadImage("src/resources/bodyParts/leftArm.png");
        BufferedImage imgRA =
            GraphicsTest.loadImage("src/resources/bodyParts/rightArm.png");
        BufferedImage imgLL =
            GraphicsTest.loadImage("src/resources/bodyParts/leftThigh.png");
        BufferedImage imgRL =
            GraphicsTest.loadImage("src/resources/bodyParts/rightThigh.png");

        BufferedImage imgLRL =
            GraphicsTest.loadImage("src/resources/bodyParts/leftFoot.png");
        BufferedImage imgLLL =
            GraphicsTest.loadImage("src/resources/bodyParts/rightFoot.png"); //nlimb
        ...
        LimbNode head =
            new LimbNode("head", torso, imgH, 0, -(torso.getHeight() / 2), 0);
        LimbNode LeftArm =
            new LimbNode("LeftArm",
                         torso,
                         imgLA,
                         -(torso.getWidth() / 2),
                         0,
        ...
        Motion m3 =
            new Motion("LRightLeg", myTree.getMap()
                                          .get("LRightLeg")
                                          .getDefaultTheta(), myTree, 500);
        Motion m4 =
            new Motion("RightLeg", myTree.getMap()
                                         .get("RightLeg")
                                         .getDefaultTheta(), myTree, 500);
        ...
        Motion m8 =
            new Motion("LLeftLeg", myTree.getMap()
                                         .get("LLeftLeg")
                                         .getDefaultTheta(), myTree, 500);
        Motion m9 =
            new Motion("LeftLeg", myTree.getMap()
                                        .get("LeftLeg")
                                        .getDefaultTheta(), myTree, 500);
    ...
    public void update (long elapsedTime)
    {
        ...
        { //attach node
            ...
            LimbNode LLLeftLeg =
                new LimbNode("LLLeftLeg",
                             myTree.getNode("LLeftLeg"),
                             LLL,
                             0,
                             40,
                             0);
