...
public class View extends JFrame {
	...
	public View(Controller controller) {
		...
		myImageSelector = new JFileChooser(System.getProperties().getProperty(
				"user.dir"));
		myFighterImageSelector = new JFileChooser(System.getProperties()
	...
	private Component makeNewFighter() {
		...
		myAddFighterButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				...
				String url = myFighterImageSelector.getSelectedFile()
						.getAbsolutePath();

				myController.addFighterSprite(new FighterSprite(MaxHealth,
						FighterX, FighterY, FighterName, Speed), url);
	...
	private Component makeNewBlock() {
		...
		myAddBlockButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				...
				String url = myImageSelector.getSelectedFile()
						.getAbsolutePath();

				myController.addInanimateSprite(new BlockSprite(), url,
						myXValue, myYValue);
	 ...
	 * file to which level data will be written and stored
	 * 
