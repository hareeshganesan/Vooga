    ...
    implements MouseListener, MouseMotionListener, KeyListener
{
    ...
    public void getMessage (Object msg, ActionEvent e)
    {
        ...
        if (e.getSource() == myAddPropertyButton)
        {
            ...
            if (value != null)
            {
                if (value.equalsIgnoreCase("")) myMainPaneModel.getFoucsComponent()
                                                               .remove(key);
                else myMainPaneModel.getFoucsComponent()
        ...
        if (e.getSource() == myConnect)
        {
            myMainPaneModel.getFoucsComponent()
                           .addChild(myMainPaneModel.getNextFocusComponent());
            myMainPaneModel.getNextFocusComponent()
                           .setParent(myMainPaneModel.getFoucsComponent());
            return;
        }
