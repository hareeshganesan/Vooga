...
public class NeedToCross extends MouseMovedState
{
    ...
    {
        if (instance == null) instance = new NeedToCross(f, e);
        instance.e = e;
        return instance;
    }
    ...
    {
        if (needToCross()) return instance;
        return null;
    }
    ...
    {
        return (e.getSource() == myFighterBuilder.getComponentPanel() && myFighterBuilder.getComponentPanel()
                                                                                         .find(e.getPoint()) != -1) ||
               (e.getSource() == myFighterBuilder.getDrawPane() &&
                myModel.findComponent(e.getPoint()) != null && myModel.getSetSizeFlag() == false);
    }
}
