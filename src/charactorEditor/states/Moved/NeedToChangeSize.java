...
public class NeedToChangeSize extends MouseMovedState
{
    ...
    {
        if (instance == null) instance = new NeedToChangeSize(f, e);
        instance.e = e;
        return instance;
    }
    ...
    {
        if (needToChangeSize()) return instance;
        return null;
    }
    ...
    {
        return (e.getSource() == myFighterBuilder.getDrawPane()) &&
               (myModel.findComponent(e.getPoint()) != null) &&
