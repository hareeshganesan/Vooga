...
public class isPutingComponentState extends MousePressedState
{
                                                   ...
                                                   MouseEvent e)
    {
        if (instance == null) instance =
            new isPutingComponentState(mainPaneModel, model, e);
        instance.e = e;
        return instance;
    }


    private isPutingComponentState (MainPaneModel mainPaneModel,
                                    Model model,
                                    MouseEvent e)
    {
    ...
    {
        if (isPuttingComponent()) return instance;
        return null;
    }
    ...
    public void action ()
    {
        ...
        mainPaneModel.setFoucsComponent(new MyComponent(mainPaneModel.getNearest(),
                                                        model.getWillPut()));
        model.getComponentList().add(mainPaneModel.getFoucsComponent());

        mainPaneModel.getFoucsComponent()
                     .setText(model.getName(mainPaneModel.getFoucsComponent()));
        model.reSetWillPut();
    }
