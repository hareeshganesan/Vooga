...
public class isRemoveComponentState extends MousePressedState
{
                                                   ...
                                                   MouseEvent e)
    {
        if (instance == null) instance =
            new isRemoveComponentState(mainPaneModel, model, e);
        instance.e = e;
        return instance;
    }


    private isRemoveComponentState (MainPaneModel mainPaneModel,
                                    Model model,
                                    MouseEvent e)
    {
    ...
    {
        if (isRemoveComponent()) return instance;
        return null;
    }
    ...
    public void action ()
    {
        if (mainPaneModel.getSelectedComponnet()
                         .contains(mainPaneModel.getFoucsComponent()))
        {
