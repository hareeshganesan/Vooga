...
public class XMLWriter
{
    ...
    private void writeToXML (Document doc)
    {
        try
        {
            ...
            FileOutputStream out =
                new FileOutputStream(new File(myLevelObject.getLevelName() +
                                              ".xml"));
    ...
    /**
     * @TODO - Use Reflection instead of hard-coded properties after requisite
     *       changes are implemented in AIAgent
     */
    private void saveAI ()
    {
