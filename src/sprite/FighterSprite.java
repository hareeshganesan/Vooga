...
/*
 * Note: speed is used to determine distance travelled upon keypresses. getSpeed
 * is used for this purpose To set actual sprite speed (moving w/o keypresses),
 * call the golden t functions
...
public class FighterSprite extends SpriteTemplate
{
    ...
    {
        // Physics Engine will take Bound problems
        // if (!this.isOnScreen())
        // {
        // this.forceX(this.getOldX());
