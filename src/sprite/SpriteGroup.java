/*
 * Update changed, everything else is copy-paste from online src code Copyright
 * (c) 2008 Golden T Studios. This program is free software: you can
...
public class SpriteGroup
{
    ...
    public void add (Sprite member)
    {
        ...
        if (++this.size >= this.sprites.length)
        {
            ...
            this.sprites =
                (Sprite[]) Utility.expand(this.sprites, this.expandFactor);
        }
    }
     ...
     * java.util.Arrays#sort(). Example of sorting sprites based on y-axis :
     * 
     * <pre>
     *    SpriteGroup ENEMY_GROUP;
     ...
     * array has been full, the array is expanded as large as this factor. For
     * example: <br>
    ...
    public String toString ()
    {
        return super.toString() + " " + "[name=" + this.name + ", active=" +
               this.getSize() + ", total=" + this.sprites.length + ", member=" +
               this.getActiveSprite() + ", background=" + this.background + "]";
    }
