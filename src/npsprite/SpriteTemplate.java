...
// all sprites in fighting game extend this template. No animation, that will be
// handled by spritetree
...
public abstract class SpriteTemplate extends Sprite
{
    ...
    private ArrayList<CompositeEvent> myCollisions =
        new ArrayList<CompositeEvent>();
