...
/*
 * Copied from golden T, but removed other ID settings Copyright (c) 2008 Golden
 * T Studios. This program is free software: you can redistribute it and/or
...
public class Sprite implements java.io.Serializable
{
    ...
    */
    ...
    public CollisionShape getDefaultCollisionShape ()
    {
        ...
        this.defaultCollisionShape.setBounds(this.getX(),
                                             this.getY(),
                                             this.getWidth(),
                                             this.getHeight());
    ...
    public boolean moveTo (long elapsedTime, double xs, double ys, double speed)
    {
        ...
        double angle =
            90 + Math.toDegrees(Math.atan2(ys - this.y, xs - this.x));
                               ...
                               int bottomOffset)
    {
        ...
        return (Sprite.screenX + this.width > -leftOffset &&
                ...
                Sprite.screenX < this.background.getClip().width + rightOffset && Sprite.screenY < this.background.getClip().height +
                                                                                                   bottomOffset);
    }
